...
const services = [
  ...
  { name: "Plants", path: "/services/plants" },
  { name: "Seeds", path: "/services/seeds" },
  { name: "Bulbs", path: "/services/bulbs" },
  { name: "Pots", path: "/services/pots" },
  { name: "Fertilizers", path: "/services/fertilizers" },
  { name: "pebbles", path: "/services/pebbles" },
  { name: "accessories", path: "/services/accessories" },
];

const Navbar = ({ openLoginModal, cart, user, onLogout }) => {
  const [location, setLocation] = useState("Ghaziabad, Uttar Pradesh");
  ...
  return (
    <nav id="Navbar" className="navbar">
      ...
      {/* Logo */}
      <div className="logo">
        <Link to="/">Gardening Solutions</Link>
      </div>
